...
namespace PoeDB
{
    public class WebRequest
    {
        public static string RequestAction(RequestOptions options)
        {
            ...
            request.UserAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.75 Safari/537.36";//设置User-Agent，伪装成Google Chrome浏览器
